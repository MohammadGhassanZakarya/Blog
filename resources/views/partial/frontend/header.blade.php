            ...
            <div class="col-lg-8 d-none d-lg-block">
                <nav class="mainmenu__nav">
                    <ul class="meninmenu d-flex justify-content-start">
                        ...
                        <li class="drop"><a href="{{route('frontend.index')}}">Blog</a>
                                ...
                                <div class="single__items">
                                    <div class="miniproduct">
                                        <div class="item01 d-flex mt--20">
                                            ...
                                            <div class="content">
                                                <h6><a href="product-details.html">Compete Track Totedancsmdvmjs dvsnakjsnka</a></h6>
                                    ...
                                    <div class="switcher-options">
                                        <div class="switcher-currency-trigger">
                                            <div class="setting__menu">
                                                ...
                                                @guest
                                                <span>
                                                    <a class="nav-link" href="{{ route('frontend.show_login_form') }}">{{ __('Login') }}</a>
                                                </span>
                                                <span>
                                                    <a class="nav-link" href="{{ route('frontend.show_register_form') }}">{{ __('Register') }}</a>
                                                </span>
                                            @else
