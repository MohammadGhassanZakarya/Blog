<div class="wn__sidebar">
            ...
            <ul>
                ...
                <li>
                    <div class="post-wrapper d-flex">
                        ...
                        <div class="content">
                            <h4><a href="{{route('posts.show',$recent_post->slug)}}">{{Str::limit($recent_post->title, 15, '...')}}</a></h4>
    ...
    <aside class="widget archives_widget">
        ...
        <ul>
            ...
            <li><a href="{{ route('frontend.archive.posts', $key.'-'.$val) }}">{{ date("F", mktime($key)) . ' ' . $val }}</a></li>
            @endforeach
        </ul>
    </aside>
    <!-- End Single Widget -->
